...
# ---------- Logo ----------
$logoPath = "C:\ProgramData\IT-Support\CRC-Logo.png"
...
$searchBtn.Add_Click({
    ...
    $sBox.Location = New-Object Drawing.Point(10,10)
    $sBox.Size = New-Object Drawing.Size(315,25)
    $sBox.BackColor = [Drawing.Color]::FromArgb(45,45,48)
    $sBox.ForeColor = [Drawing.Color]::White

    $lBox = New-Object Windows.Forms.ListBox
    $lBox.Location = New-Object Drawing.Point(10,40)
    $lBox.Size = New-Object Drawing.Size(315,300)
    $lBox.BackColor = [Drawing.Color]::FromArgb(30,30,30)
    $lBox.ForeColor = [Drawing.Color]::White
    $lBox.BorderStyle = "None"
...
$send.Add_Click({
    ...
    if($problem -eq "Outlook Issue | مشكلة فى الايميل"){
        ...
        $key        = [byte[]](1..16)
        $securePass = ConvertTo-SecureString "" -Key $key
        ...
        if($ccAddress){ $params.Cc = $ccAddress }
